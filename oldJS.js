...
function addNewItem(){
  ...
  newDiv.append('<button class="btn btn-primary delete-button">Delete</>').click(function(){
    $.ajax({
  ...
  newDiv.append('<button class="btn btn-primary done-button">Done</>').click(function(){
    $.ajax({
      "url": "http://localhost:3000/todo/" + item.id,
      "method" : "PUT",
      "success": function (todo){
